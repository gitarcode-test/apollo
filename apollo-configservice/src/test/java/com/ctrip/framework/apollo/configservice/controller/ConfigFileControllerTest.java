...
public class ConfigFileControllerTest {
  @Mock private ConfigController configController;
  @Mock private WatchKeysUtil watchKeysUtil;
  @Mock private NamespaceUtil namespaceUtil;
  ...
  @Mock private HttpServletResponse someResponse;
  @Mock private HttpServletRequest someRequest;
  ...
  public void testQueryConfigAsProperties() throws Exception {
    ...
    String cacheKey =
        configFileController.assembleCacheKey(
            ConfigFileController.ConfigFileOutputFormat.PROPERTIES,
            someAppId,
            someClusterName,
            someNamespace,
            someDataCenter);
    ...
    ResponseEntity<String> response =
        configFileController.queryConfigAsProperties(
            someAppId,
            someClusterName,
            someNamespace,
            someDataCenter,
  ...
  public void testQueryConfigAsJson() throws Exception {
    ...
    ResponseEntity<String> response =
        configFileController.queryConfigAsJson(
            someAppId,
            someClusterName,
            someNamespace,
            someDataCenter,
